					...
					<hr>
						<div class="card">
							<div class="card-body p-4">
								<h5 class="mb-4"></h5>
								<form class="row g-3" method="post" id="myForm" action="{{ route('update.property') }}" enctype="multipart/form-data">
									@csrf
                                    <input type="hidden" name="id" id="" value="{{$property->id}}">
									<div class="col-md-6 form-group">
										<label for="input1" class="form-label">Property Name</label>
										<input type="text" name="property_name" class="form-control" id="input1" placeholder="Property Name" value="{{$property->property_name}}">
									</div>
									<div class="col-md-6 form-group">
										...
										<select id="input7" class="form-select" name="property_status">
											...
											@foreach($propertyAll as $item)
                                                <option value="{{ $item->property_status }}" {{ $item->property_status == $property->property_status ? 'selected' : '' }}>{{ $item->property_status }}</option>
                                            @endforeach
										</select>
									</div>
									<div class="col-md-6 form-group">
									...
									<div class="col-md-6 form-group">
										...
										<input type="file" name="property_thumbnail" class="form-control" id="image">
                                            
									</div>
									<div class="col-md-6">
										<div>
                                            <img src="{{asset($property->property_thumbnail)}}" id="showImage" alt="" width="90px" height="90px">
                                        </div>
									</div>
									<div class="col-md-6">
										<label for="input1" class="form-label">No. of Bedrooms</label>
										<input type="number" name="bedrooms" class="form-control" id="input1" value="{{$property->bedrooms}}">
									</div>
									<div class="col-md-6">
										<label for="input1" class="form-label">No. of Bathrooms</label>
										<input type="number" name="bathrooms" class="form-control" id="input1" value="{{$property->bathrooms}}">
									</div>
									<div class="col-md-6">
										<label for="input1" class="form-label">No. of Garage</label>
										<input type="number" name="garage" class="form-control" id="input1" value="{{$property->garage}}">
									</div>
									<div class="col-md-6">
										<label for="input1" class="form-label">Property Size</label>
										<input type="text" name="property_size" class="form-control" id="input1" value="{{$property->property_size}}">
									</div>
									<div class="col-md-6">
										<label for="input1" class="form-label">Property Video</label>
										<input type="text" name="property_video" class="form-control" id="input1" value="{{$property->property_video}}">
									</div>
									<div class="col-md-6">
									...
									<div class="col-md-6">
										...
										<input type="text" class="form-control" id="input8" name="city" placeholder="City" value="{{$property->city}}">
									</div>
									<div class="col-md-6">
										...
										<select id="input9" class="form-select" name="state">
                                            ...
                                            @foreach ($propertyAll as $item)
                                            <option value="{{$item->state}}" {{$item->state == $property->state ? 'selected' : ''}}>{{$item->state}}</option>
                                            @endforeach
										</select>
									</div>
									<div class="col-md-12">
									...
									<div class="col-md-6">
										<div class="form-check">
											<input class="form-check-input" type="checkbox" id="input12" value="1" name="featured" {{ $property->featured == '1' ? 'checked' : '' }}>

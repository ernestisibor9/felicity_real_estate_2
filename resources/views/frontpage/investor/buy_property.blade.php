          ...
          <div class="row">
            <div class="col-md-12">
              <div class="title-wrap d-flex justify-content-between">
                <div class="title-box">
                  <h2 class="title-a">Buy Property </h2>
                </div>
              </div>
              <h5 class="text-center text-dark">Please fill the form below </h5>
            </div>
          </div>
          <form action="{{route('store.investor.buy')}}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
              ...
              <div class="col-md-12 mb-3">
                <div class="form-group">
                    <select name="buy_category" id="" class="form-select form-control-lg form-control-a" >
                        <option value="" disabled>Category of Property to Buy *</option>
                        <option value="finished property">Finished Property</option>
                        <option value="unfinished property">Unfinished Property</option>
                        <option value="land property">Land</option>
                    </select>
                </div>
              </div>
              <div class="col-md-12 mb-3">

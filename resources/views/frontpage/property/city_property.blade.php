    ...
    <section class="mt-5">
        <div class="container-fluid mt-5">
                ...
                <div class= 'col-md-3' style='margin-top:20px;'>
                    <form action="{{ route('store.filter.finished') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="price-range-block">
                            ...
                            <div id="slider-range" class="price-filter-range" name="rangeInput" style='width:180px;'>
                            </div>

                            <div style="margin-top: 10px;" class="d-flex justify-content-between mb-3">
                            ...
                            <button type = 'submit' class='btn btn-success mb-3'><i class="fa-solid fa-filter"></i>
                                Filter</button>
                    ...
                    <div>
                        ...
                        <form action="{{ route('store.filter.property.type') }}" method="post"
                            ...
                            <button type = 'submit' class='btn btn-danger mt-3'><i class="fa-solid fa-filter"></i>
                                Filter</button>
                        </form>
                    </div>
                </div>
            ...
            <div class = 'col-md-9 mt-3'>
                ...
                <h2 class="text-center finish-head" style="margin-top: 80px; margin-bottom:30px;">Finished Properties in
                    {{ $prop->citys->city }}</h2>
                                            ...
                                            <div class="card-body-a">
                                                <div class="price-box d-flex">
                                                    <span class="price-a">Price | &#8358;
                                                        {{ number_format($item->price) }} m</span>
                                                </div>
                                                <div>
                                                    <a href="{{ route('buy.finished.property', $item->id) }}"
                                                        class="link-a">Click here to buy

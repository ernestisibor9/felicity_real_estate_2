...
@section('main')
      @section('title')
        Felicity Properties - Rent Property Tenant
      @endsection
		<main id="main">
             <!-- =======Intro Single ======= -->
    <!-- End Intro Single-->
      ...
      <section class="section-services section-t8">
        <div class="container">
          ...
          <form action="{{route('store.rent.property')}}" method="post" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="rent_category" id="" value="{{$property->property_category}}">
            <div class="row">
              ...
              <div class="col-md-12 mb-3">
                <div class="form-group">
                    <select name="evicted" id="" class="form-select form-control-lg form-control-a" >
                        <option value="">Have you ever been evicted or had any rental-related issue in the past *</option>
              ...
              <div class="col-md-12 mb-3">
                <div class="form-group">
                  <textarea name="rented_before" class="form-control" cols="45" rows="4" placeholder="Have you rented a property before? If yes, what did you like and dislike about your previous rental experience? *" required=""></textarea>
                </div>
              </div>
              <div class="col-md-12 mb-3">
                <div class="form-group">
                  <textarea name="workplace" class="form-control" cols="45" rows="4" placeholder="Where is your workplace, and how do you plan to commute *" required=""></textarea>
                </div>
              </div>
              <div class="col-md-12 mb-3">
                <div class="form-group">
